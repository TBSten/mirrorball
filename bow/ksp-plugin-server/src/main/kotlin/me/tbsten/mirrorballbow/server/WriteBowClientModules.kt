...
internal fun Writer.writeBowClientModules(clientPageModules: Map<String, BowClientModule>) =
    LinedWriter(this).apply {
        ...
        clientPageModules.forEach { (modulePath, module) ->
            ...
            writeln(
                """    data object $moduleEntryName : BowClientModule("${module.module}", File("${module.projectDir}"), File("${module.staticDir}"))""",
            )
        }
        writeln("}")
        writeln()
