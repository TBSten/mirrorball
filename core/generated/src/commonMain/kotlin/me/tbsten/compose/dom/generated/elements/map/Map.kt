...
@Composable
public fun Map(
  attrs: MapAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable MapContentScope.() -> Unit = { },
) {
  val attrsScope = MapAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = MapContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "map", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
