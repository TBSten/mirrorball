...
@Composable
public fun Rp(
  attrs: RpAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable RpContentScope.() -> Unit = { },
) {
  val attrsScope = RpAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = RpContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "rp", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
