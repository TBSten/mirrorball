...
@Composable
public fun Style(
  attrs: StyleAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable StyleContentScope.() -> Unit = { },
) {
  val attrsScope = StyleAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = StyleContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "style", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
