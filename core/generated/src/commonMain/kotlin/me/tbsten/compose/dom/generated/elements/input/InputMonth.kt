...
@Composable
public fun InputMonth(
  attrs: InputMonthAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable InputMonthContentScope.() -> Unit = { },
) {
  val attrsScope = InputMonthAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = InputMonthContentScope(ref)
  scope.content()
  }
