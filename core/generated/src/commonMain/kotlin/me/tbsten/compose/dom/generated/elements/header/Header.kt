...
@Composable
public fun Header(
  attrs: HeaderAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable HeaderContentScope.() -> Unit = { },
) {
  val attrsScope = HeaderAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = HeaderContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "header", attrs = { applyScope(attrsScope) }, ref = ref, content =
      tagContent,)
}
