...
@Composable
public fun InputButton(
  attrs: InputButtonAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable InputButtonContentScope.() -> Unit = { },
) {
  val attrsScope = InputButtonAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = InputButtonContentScope(ref)
  scope.content()
  }
