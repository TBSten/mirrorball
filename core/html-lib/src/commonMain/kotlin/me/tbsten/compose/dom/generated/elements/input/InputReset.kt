...
@Composable
public fun InputReset(
  attrs: InputResetAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  dangerouslySetInnerHTML: String? = null,
  content: @Composable InputResetContentScope.() -> Unit = { },
) {
  val attrsScope = InputResetAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = InputResetContentScope(ref)
  scope.content()
  }
