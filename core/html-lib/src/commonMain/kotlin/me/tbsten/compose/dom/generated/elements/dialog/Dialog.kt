...
@Composable
public fun Dialog(
  attrs: DialogAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  dangerouslySetInnerHTML: String? = null,
  content: @Composable DialogContentScope.() -> Unit = { },
) {
  val attrsScope = DialogAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = DialogContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "dialog", attrs = { applyScope(attrsScope) }, ref = ref, content =
