...
@Composable
public fun Footer(
  attrs: FooterAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable FooterContentScope.() -> Unit = { },
) {
  val attrsScope = FooterAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = FooterContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "footer", attrs = { applyScope(attrsScope) }, ref = ref, content =
      tagContent,)
}
