...
@Composable
public fun Audio(
  attrs: AudioAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable AudioContentScope.() -> Unit = { },
) {
  val attrsScope = AudioAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = AudioContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "audio", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
