...
@Composable
public fun Rt(
  attrs: RtAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable RtContentScope.() -> Unit = { },
) {
  val attrsScope = RtAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = RtContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "rt", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
