...
@Composable
public fun Div(
  attrs: DivAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable DivContentScope.() -> Unit = { },
) {
  val attrsScope = DivAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = DivContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "div", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
