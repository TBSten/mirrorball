...
public fun InputText(
  attrs: InputTextAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  dangerouslySetInnerHTML: String? = null,
  content: @Composable InputTextContentScope.() -> Unit = { },
) {
  val attrsScope = InputTextAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = InputTextContentScope(ref)
  scope.content()
  }
