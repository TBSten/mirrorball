...
@Composable
public fun Embed(
  attrs: EmbedAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable EmbedContentScope.() -> Unit = { },
) {
  val attrsScope = EmbedAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = EmbedContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "embed", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
