...
@Composable
public fun Menu(
  attrs: MenuAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable MenuContentScope.() -> Unit = { },
) {
  val attrsScope = MenuAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = MenuContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "menu", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
