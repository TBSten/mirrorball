...
@Composable
public fun Track(
  attrs: TrackAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable TrackContentScope.() -> Unit = { },
) {
  val attrsScope = TrackAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = TrackContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "track", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
