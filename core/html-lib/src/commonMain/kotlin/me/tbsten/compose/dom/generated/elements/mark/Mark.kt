...
@Composable
public fun Mark(
  attrs: MarkAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable MarkContentScope.() -> Unit = { },
) {
  val attrsScope = MarkAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = MarkContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "mark", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
