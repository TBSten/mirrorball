...
@Composable
public fun Dd(
  attrs: DdAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  content: @Composable DdContentScope.() -> Unit = { },
) {
  val attrsScope = DdAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = DdContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "dd", attrs = { applyScope(attrsScope) }, ref = ref, content = tagContent,)
}
