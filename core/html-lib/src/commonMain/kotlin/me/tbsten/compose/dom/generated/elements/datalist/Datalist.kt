...
@Composable
public fun Datalist(
  attrs: DatalistAttrsScope.() -> Unit = { },
  ref: HtmlTagRef = rememberDefaultHtmlTagRef(),
  dangerouslySetInnerHTML: String? = null,
  content: @Composable DatalistContentScope.() -> Unit = { },
) {
  val attrsScope = DatalistAttrsScope(ref = ref).apply { attrs() }
  val tagContent :  @Composable() (HtmlTagContentScope.() -> Unit) = {
  val scope = DatalistContentScope(ref)
  scope.content()
  }
  HtmlTag(localName = "datalist", attrs = { applyScope(attrsScope) }, ref = ref, content =
